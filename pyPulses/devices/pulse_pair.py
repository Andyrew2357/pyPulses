...
from ..routines.wfatd import wfAverager
...
class pulsePair(abstractDevice):
    def __init__(self,
        ...
        self._xpol: bool | None = None
        self._xtuning = {
            True:  {'dT0': 0.0, 'dT1': 0.0},
            False: {'dT0': 0.0, 'dT1': 0.0},
        }
        self._ypol: bool | None = None
        self._ytuning = {
            True:  {'dT0': 0.0, 'dT1': 0.0},
            False: {'dT0': 0.0, 'dT1': 0.0},
        }
    ...
    def dT1(self, dt: float | None = None) -> float | None:
        dT1X = self._xtuning[self._xpol]['dT1']
        dT1Y = self._ytuning[self._ypol]['dT1']
        if dt is None:
    ...
    def _switch_xpolarity(self):
        ...
        # Invert the polarity
        self._xpol = not self._xpol
        self._relay.xpolarity(self._xpol)
    ...
    def _switch_ypolarity(self):
        ...
        # Invert the polarity
        self._ypol = not self._ypol
        self._relay.xpolarity(self._ypol)
